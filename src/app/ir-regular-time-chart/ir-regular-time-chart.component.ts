...
@Component({
  ...
  templateUrl: './ir-regular-time-chart.component.html',
  styleUrls: ['./ir-regular-time-chart.component.css']
})
export class IrRegularTimeChartComponent implements OnInit {
